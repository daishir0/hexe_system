...
Private Sub Form_Load()
    ...
    Label2.Caption = Format(DateAdd("n", 18, frmMain.Start_Time), "hh:nn")
    Label3.Caption = Format(DateAdd("n", 38, frmMain.Start_Time), "hh:nn")
    Label4.Caption = Format(DateAdd("n", 54, frmMain.Start_Time), "hh:nn")
    Label5.Caption = Format(DateAdd("n", 72, frmMain.Start_Time), "hh:nn")
...
Private Sub Timer2_Timer()
    ...
    Label2.Caption = Format(DateAdd("n", SpendTime / 5, frmMain.Start_Time), "hh:nn")
    Label3.Caption = Format(DateAdd("n", SpendTime / 5 * 2, frmMain.Start_Time), "hh:nn")
    Label4.Caption = Format(DateAdd("n", SpendTime / 5 * 3, frmMain.Start_Time), "hh:nn")
    Label5.Caption = Format(DateAdd("n", SpendTime / 5 * 4, frmMain.Start_Time), "hh:nn")
End Sub
